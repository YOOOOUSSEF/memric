    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 1:
          res = _context2.v;
          if (res.data.status === 'success') {
            location.reload(true); //to not get the page from the cashe, get the page from the server.
          }
          _context2.n = 3;
          break;
        case 2:
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/youssef1234/cmm4su4ku000e01qz3m9ihsq5',
    // style URL
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          return _context.a(2, (0, _alerts.showAlert)('error', 'Payment system failed to load. Please refresh.'));
        case 1:
          stripe = Stripe('pk_test_51TVUpYH7DmcOPOEDKVa8Q4K2uyBKdXgF7i9FqrJNsBZdgPQ4x08mpiEqGc4ooCCtriGizYuCCzQpwOyZrWDs7ORw00MAtTckDC'); // 1) Get checkout session from Api
          _context.n = 2;
          return (0, _axios.default)({
            method: 'GET',
...
if (logoutBut) logoutBut.addEventListener('click', _login.logout);
if (bookBtn) {
